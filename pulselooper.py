...
with open(README_PATH, "w") as f:
    ...
    f.write("\n")
    f.write("\n")
    f.write("You can listen to the file using : \n")
    f.write("aplay -f FLOAT_LE -r 44100 -c 2 buffer_01.raw")
    f.write("\n")
    f.write("\n")
    f.write("You can convert them using : \n")
    f.write("\n")
    f.write('ffmpeg -f f32le -ar 44100 -ac 2 -i buffer_01.raw -af "volume=0.5" buffer_01.wav')
    f.write("\n")
    f.write('for f in buffer_*.raw; do  ffmpeg -f f32le -ar 44100 -ac 2 -i "$f" "${f%.raw}.wav" ; done')
    f.write("\n")
    f.write("\n")
